...
namespace Splitter.Touch.Views.PanelContainers
{
    public class SplitDetailPanelContainer : PanelContainer
    {
        ...
        /// </summary>
        public SplitDetailPanelContainer(SplitPanelView parent)
        ...
        public SplitDetailPanelContainer(DetailPanelContainer detail, SplitPanelView parent)
            : base(new UIViewController())
        {
            _parent = parent;
        ...
        /// <param name="detail">Detail page</param>
        /// <param name="parent">parent split panel</param>
        public SplitDetailPanelContainer(DetailPanelContainer detail, SubMenuPanelContainer subMenu, SplitPanelView parent)
            : base(new UIViewController())
        {
            _parent = parent;
            DetailContainer = detail;
